                ...
                <div class="grid max-w-7xl mx-auto px-5">
                    <div class="footer_info flex flex-wrap justify-between gap-8">
                        <div class="footer_info-content flex-1 min-w-[220px]">
                            <img src="{{ asset('storage/products/Gemini_Generated_Image_krh9ixkrh9ixkrh9-fotor-20241009183056-removebg-preview.png') }}" alt="Logo" class="footer_info-logo max-w-[140px] mb-4">
                        </div>

                        <div class="footer_info-content flex-1 min-w-[220px]">
                            <h4 class="footer_info-heading font-bold mb-2">THÔNG TIN LIÊN HỆ</h4>
                            <div class="footer_info-line w-10 h-0.5 bg-white mb-2"></div>
                            <p class="footer_info-text text-sm mb-1.5">Số hotline được trực trong khung giờ từ 9h-17h mỗi T2 – T7 hàng tuần</p>
                        ...
                        <div class="footer_info-content flex-1 min-w-[220px]">
                            ...
                            <div class="footer_info-line w-10 h-0.5 bg-white mb-2"></div>
                            <a href="#" class="footer_info-policy block text-white text-sm mb-1.5 hover:underline">Chính sách bảo hành</a>
                            <a href="#" class="footer_info-policy block text-white text-sm mb-1.5 hover:underline">Chính sách đổi trả</a>
                            <a href="#" class="footer_info-policy block text-white text-sm mb-1.5 hover:underline">Chính sách vận chuyển</a>
                            <a href="#" class="footer_info-policy block text-white text-sm mb-1.5 hover:underline">Chính sách bảo mật</a>
                            <a href="#" class="footer_info-policy block text-white text-sm mb-1.5 hover:underline">Câu hỏi thường gặp</a>
                        </div>
                        ...
                        <div class="footer_info-content flex-1 min-w-[220px]">
                            ...
                            <a href="https://www.facebook.com/profile.php?id=61576996803922" class="footer_info-btn">
                                <img src="{{ asset('storage/products/Facebook_Logo_(2019).png') }}" alt="Facebook" class="footer_info-logo max-w-[100px] mb-4">
                            </a>
                        </div>
                    </div>
